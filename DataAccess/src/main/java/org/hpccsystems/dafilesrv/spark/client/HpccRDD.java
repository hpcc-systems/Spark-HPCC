...
public class HpccRDD extends RDD<Row> implements Serializable {
   ...
   * @param recordDef
  */
  public HpccRDD(SparkContext sc, DataPartition[] dataParts, RecordDef4Spark recordDef)
  {
  ...
  public InterruptibleIterator<Row> compute(Partition p_arg, TaskContext ctx) {
    ...
    final RecordDef4Spark rd = this.def;
    Iterator<Row> iter = new Iterator<Row>() {
      private HpccRemoteFileReader4Spark rfr = new HpccRemoteFileReader4Spark(this_part, (RecordDef)rd);
      //WS
